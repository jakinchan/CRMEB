...
return [
    ...
    '验证码有效期为{:minute}分钟' => 'The code is valid for {:minute} minutes',
    '如果这不是您本人的操作，请忽略此邮件' => 'If you did not request this, please ignore this email',
    '邮箱已注册' => 'This email is already registered',
    '邮箱格式不正确' => 'The email address format is incorrect',
    '邮箱注册未开启' => 'Email registration is not enabled',
    '请输入邮箱' => 'Please enter your email address',
    '邮箱注册' => 'Email',
    '手机号注册' => 'Phone',
    '同一邮箱每分钟最多发送' => 'Maximum emails per minute for the same address:',
    '同一邮箱每天最多发送' => 'Maximum emails per day for the same address:',
    '邮箱注册未开启' => 'Email registration is not enabled',
];
